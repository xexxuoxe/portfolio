					...
					<header>
						...
						<div className={styles.detail_sub_title}>
							...
							<div className={styles.sub_title_cont}>
									...
									<h3>Pioneer Platform을 기반으로 한 IT 자산 관리 프로그램을 개발하였으며, WEB과 Eg Manager를 활용한 대시보드를 구현하여 효율적인 자산 관리와 모니터링을 지원하는 시스템을 구축하였습니다.<br />
									IT 자산 관리의 효율성을 극대화하고, 실시간 데이터 분석 및 관리 기능을 제공하는 프로젝트입니다.</h3>
